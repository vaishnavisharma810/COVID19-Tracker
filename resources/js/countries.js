...
/*...........Country Filter.....................*/
/*Input event fires only when the input value changes*/
input.addEventListener("input", function(){
    let value = input.value.toUpperCase();
    country_list.forEach(country => {
        if(country.name.toUpperCase().startsWith(value)){
            document.getElementById(country.name).classList.remove("hide")    /*Country name is the id of the country in country list */
        }
        else{
